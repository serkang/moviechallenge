        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpisodeNo = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EpisodeRatings_Episodes_imdbId",
                        column: x => x.imdbId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieRatings_Movies_imdbId",
                        column: x => x.imdbId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SerieRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SerieRatings_Series_imdbId",
                        column: x => x.imdbId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EpisodeRatings_imdbId",
                schema: "dbo",
                table: "EpisodeRatings",
                column: "imdbId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieRatings_imdbId",
                schema: "dbo",
                table: "MovieRatings",
                column: "imdbId");

            migrationBuilder.CreateIndex(
                name: "IX_SerieRatings_imdbId",
                schema: "dbo",
                table: "SerieRatings",
                column: "imdbId");
        }
